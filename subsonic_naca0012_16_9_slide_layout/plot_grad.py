...
pdfName = './naca_optimization_results_16_9.pdf'
...
wide_figsize=(14,6)
big_figsize=(14,12)
wide_16_9_figsize=(16,7)
vertical_16_9_figsize=(8,7)
figsize = wide_figsize
figsize = wide_16_9_figsize
...
fig_FS_subiter, axs_FS_subiter = plt.subplots(len(n_dofs_list),figsize=figsize,sharex=True)
fig_RS_subiter, axs_RS_subiter = plt.subplots(len(n_dofs_list),figsize=figsize,sharex=True)

#fig_all_cycles, axs_all_cycles = plt.subplots(1,len(n_dofs_list),figsize=figsize,sharex=True)
fig_all_cycles, axs_all_cycles = plt.subplots(1,len(n_dofs_list),figsize=wide_16_9_figsize,sharey=True)

plt.figure("gradnorm_vs_designcycles",figsize=figsize)
ax_gradvscycles = plt.gca()

fig_work, axs_work = plt.subplots(1,2,figsize=wide_16_9_figsize,sharey=True)
...
for poly in poly_list:
    ...
    plt.figure("work_vs_nctl_2",figsize=vertical_16_9_figsize)
    ...
    axs_work[0].plot(n_design_list_more,
            work_list,
            linestyle = linestyle_str[poly],
            color=color_str[bfgs_color],
            marker=marker_str[poly],
...
for i,n_design in enumerate(WorkvsNDOFS_design_list):
    ...
    plt.figure("work_vs_nstate",figsize=vertical_16_9_figsize)
    plt.plot(x, y,
...
#                label=r'RS-N, $m$ = '+str(n_dofs_list[poly]))
    ...
    axs_work[0].plot(n_design_list_more, work_list, '-.o',
            linestyle = linestyle_str[poly],
            color=color_str[newton_color],
            marker=marker_str[poly],
            ms=marker_size,
            label=r'RS-N, $m$ = '+str(n_dofs_list[poly]))
            #label=r'RS-N, $p$ = '+str(poly))
    plt.figure("work_vs_nctl_3",figsize=vertical_16_9_figsize)
    plt.plot(n_design_list_more, work_list, '-.o',
            linestyle = linestyle_str[poly],
            color=color_str[newton_color],
...
axs_all_cycles[0].legend(loc=1)
for i,ax in enumerate(axs_all_cycles):
    ax.set_title(r'$m$ = ' + str(n_dofs_list[i]))
    #ax.set(xlabel='Number of design cycles', ylabel='Gradient Norm')
    ax.set(xlabel='Design Cycles')
    #ax.set(ylabel='Gradient Norm')
...
#axs_all_cycles[-1].set(ylabel='Gradient Norm')
axs_all_cycles[0].set(ylabel='Gradient Norm')
...
plt.figure(fig_work)
#axs_work[0].set_title(r'Work Units vs Control Variables')
axs_work[0].set(xlabel=r'Number of Control Variables $n$')
axs_work[0].set(ylabel=r'Work units to Convergence')
axs_work[0].grid(b=True, which='major', color='black', linestyle='-',alpha=0.2)
#axs_work[0].legend(loc=2)
fig_work.tight_layout()
#pp.savefig(bbx_inches='tight')

#axs_work[1].title(r'Work Units vs State Variables')
axs_work[1].set(xlabel=r'Number of State Variables $m$')
#axs_work[1].set(ylabel=r'Work Units to Convergence')
axs_work[1].grid(b=True, which='major', color='black', linestyle='-',alpha=0.2)
axs_work[1].legend()
plt.tight_layout()
pp.savefig(bbx_inches='tight')
plt.close()
