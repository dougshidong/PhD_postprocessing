...
ReducedGradientvsSubiterations_design_list = [20,60,100]
...
#ax_gradvscycles = plt.figure("gradnorm_vs_designcycles",figsize=figsize)
...
plt.figure("gradnorm_vs_designcycles",figsize=figsize)
ax = ax_gradvscycles
ax.set_title(r'Gradient Norm vs Design Cycles m = ' + str(n_dofs_list[0]))
