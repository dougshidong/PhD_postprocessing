...
#n_design_list_more = [20, 40, 80, 160, 320, 640]
#n_design_list_more = [20, 40]#, 320, 640]

GradientvsSubiterations_design_list = [20, 40, 60, 80]
GradientvsSubiterations_design_list = [20, 40, 80, 160, 320, 640]
ReducedGradientvsSubiterations_design_list = n_design_list #[20, 40, 60, 80]
...
fig_FS_subiterations, axs_FS_subiter = plt.subplots(len(n_dofs_list), figsize=big_figure_size, sharex=True)
fig_RS_subiterations, axs_RS_subiter = plt.subplots(len(n_dofs_list), figsize=big_figure_size, sharex=True)

plt.figure("gradnorm_vs_designcycles", figsize=figure_size)
...
for polyindex, poly in enumerate(poly_list):
    ...
    for n_design in n_design_list:
        ...
        plt.figure(value_vs_cycles_figure_name, figsize=figure_size)
        final_value = 0
...
for polyindex, poly in enumerate(poly_list):
    ...
    plt.figure("Iterations_vs_nctl_FullSpace", figsize=figure_size)
...
for polyindex, poly in enumerate(poly_list):
    plt.figure('FullspaceGradientvsSubiterations' + str(poly), figsize=figure_size)
    plt.title(r'Full-space Gradient vs Subiterations, $m$ = ' + str(n_dofs_list[polyindex]))
...
# plt.grid(visible=True, which='major', color='black', linestyle='-',alpha=0.2)
# plt.legend()
fig_FS_subiterations.suptitle(r'Full-space Gradient vs Subiterations')
fig_FS_subiterations.tight_layout()
fig_FS_subiterations.subplots_adjust(top=0.92)
pp.savefig(fig_FS_subiterations, bbox_inches='tight')
...
fig_RS_subiterations.suptitle(r'Reduced-space Gradient vs Design Cycles')
fig_RS_subiterations.tight_layout()
fig_RS_subiterations.subplots_adjust(top=0.92)
pp.savefig(fig_RS_subiterations, bbox_inches='tight')
