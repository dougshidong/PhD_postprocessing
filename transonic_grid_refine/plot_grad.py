...
pdfName = './naca_drag_minimization_lift_volume_constrained_results_href.pdf'
...
n_dofs_list = [648*n_state*1, 648*n_state*2, 648*n_state*2*2]
...
GradientvsSubiterations_design_list = [10, 20, 40, 80]
...
for polyindex, poly in enumerate(poly_list):
    ...
    plt.plot(n_design_list_more, n_iterations_list,
             ...
             ms=marker_size - 1,
             label=r'Reduced-space $m$ = ' + str(n_dofs_list[polyindex]))
...
# plt.grid(visible=True, which='major', color='black', linestyle='-',alpha=0.2)
# plt.legend()
fig_FS_cycles.suptitle(r'Full-space Gradient vs Subiterations')
