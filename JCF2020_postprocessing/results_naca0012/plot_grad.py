...
for poly in poly_list:
    ...
    plt.plot(n_design_list, n_iterations_list, '-o', ms=marker_size,
            label=r'Reduced-space BFGS, $m$ = '+str(n_dofs_list[poly]))
...
#                label=r'Reduced-space Newton, $m$ = '+str(n_dofs_list[poly]))
    ...
    plt.plot(n_design_list_more, work_list, '-.o',
            ...
            ms=marker_size,
            label=r'Reduced-space Newton, $m$ = '+str(n_dofs_list[poly]))
#                label=r'Full-space RNSQP, $m$ = '+str(n_dofs_list[poly]))
...
#                label=r'Reduced-space Newton, $m$ = '+str(n_dofs_list[poly])) ' apply AD operators')
...
#  
#              plt.figure(opttype+str(poly),figsize=figsize)
#              plt.title(r'Full-space with $\mathbf{P}_4$ Gradient vs Design Cycles, $m$ = '+str(n_dofs_list[poly]))
#              plt.semilogy(itera, gnorm, '-o', ms=marker_size,
#                      label=r'$n$ = ' + str(n_design)
#                      )#+'  time='+str(time))
#              table_line = '%10d & %10d & %16s & %10d & %10d & %10.1f & %10d & %10.1f \\\\' % (
...
#                  marker=marker_str[0],
#                  ms=marker_size+2,
#                  label=r'Full-space $\mathbf{P}_4$, $m$ = '+str(n_dofs_list[poly]))
#  
...
#         
#                     plt.figure(opttype+str(poly),figsize=figsize)
#                     plt.title(r'Full-space with $\mathbf{P}_2$ Gradient vs Design Cycles, $m$ = '+str(n_dofs_list[poly]))
#                     plt.semilogy(itera, gnorm, '-o', ms=marker_size,
#                             label=r'$n$ = ' + str(n_design)
#                             )#+'  time='+str(time))
#         
...
#                         marker=marker_str[1],
#                         ms=marker_size+1,
#                         label=r'Full-space $\mathbf{P}_2$, $m$ = '+str(n_dofs_list[poly]))
#         
#                 plt.figure("work_vs_nctl",figsize=figsize)
#                 plt.plot(n_design_list,
#                         work_list,
...
#    
#                plt.figure(opttype+str(poly),figsize=figsize)
#                plt.title(r'Full-space with $\tilde{\mathbf{P}}_4$ Gradient vs Design Cycles, $m$ = '+str(n_dofs_list[poly]))
#                plt.semilogy(itera, gnorm, '-o', ms=marker_size,
#                        label=r'$n$ = ' + str(n_design)
#                        )#+'  time='+str(time))
#                table_line = '%10d & %10d & %16s & %10d & %10d & %10.1f & %10d & %10.1f \\\\' % (
...
#                    marker=marker_str[2],
#                    ms=marker_size,
#                    label=r'Full-space $\tilde{\mathbf{P}}_4$, $m$ = '+str(n_dofs_list[poly]))
#    
#            plt.figure("work_vs_nctl",figsize=figsize)
#            plt.plot(n_design_list,
#                    work_list,
...
for poly in poly_list:
    ...
    plt.plot(n_design_list_more, n_iterations_list,
            ...
            marker=marker_str[3],
            ms=marker_size-1,
            label=r'Full-space $\tilde{\mathbf{P}}_2$, $m$ = '+str(n_dofs_list[poly]))
